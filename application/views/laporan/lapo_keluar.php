                    ...
                    <div class="x_content">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <?php echo form_open('keluar/laporan', array('id' => 'FormLaporan')); ?>
...
$(document).ready(function(){	
	...
	$('#FormLaporan').submit(function(e){
		...
		{
			var URL = "<?php echo site_url('keluar/aksi_lapor'); ?>/" + TanggalDari + "/" + TanggalSampai;
			$('#result').load(URL);
		}
		else
		{
			var URL = "<?php echo site_url('keluar/aksi_laporan'); ?>/" + TanggalDari + "/" + TanggalSampai + "/" + Sumberdana;
			$('#result').load(URL);
		}
	});
});
