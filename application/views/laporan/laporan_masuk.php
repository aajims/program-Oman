<?php if($masuk->num_rows() > 0) { ?>
	...
	<p>
		...
		$sumber = $row->id_kas;
		?>
		<a href="<?php echo site_url('masuk/laporan_pdf/'.$from.'/'.$to.'/'.$sumber); ?>" target='blank' class='btn btn-default'><img width="45" height="45" src="<?php echo base_url(); ?>assets/img/pdf.jpg"> Export ke PDF</a>
	</p>
	<br />
<?php } ?>
