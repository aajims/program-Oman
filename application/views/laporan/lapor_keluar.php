<?php if($keluar->num_rows() > 0) { ?>
	...
	<p>
		...
		?>
		<a href="<?php echo site_url('keluar/lapor_pdf/'.$from.'/'.$to); ?>" target='blank' class='btn btn-default'><img width="45" height="45" src="<?php echo base_url(); ?>assets/img/pdf.jpg"> Export ke PDF</a>
	</p>
	<br />
<?php } ?>
